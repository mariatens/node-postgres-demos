...
async function doDemo() {
  // To connect to most cloud-hosted dbs you need to specify an object value for the ssl option
  ...
  //Change the table name to match one in your cloud-hosted database!
